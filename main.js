    ...
    .defines(function () {
        ...
        MenuGameOver = Menu.extend({
            ...
            init: function () {
                ...
                this.stats.submit({ score: ig.game.score, wave: ig.game.wave.wave, streak: ig.game.longestStreak, accuracy: ig.game.hits ? (ig.game.hits / (ig.game.hits + ig.game.misses)) * 100 : 0 });
                this.timer = new ig.Timer();
            },
            update: function () {
        ...
        DetailedStats = ig.Class.extend({
            ...
            drawOnCanvas: function (canvas, mx, my) {
                ...
                if (plot) {
                    ...
                    var date = plot.game.created.toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" });
                    ctx.fillStyle = "#aaa";
                    ctx.font = "10px sans-serif";
...
ig.module("game.menus.title")
    .requires("game.menus.base", "game.menus.settings", "game.menus.detailed-stats", "game.ease")
    .defines(function () {
        ...
        MenuItemChangeURL = MenuItem.extend({
            getText: function () {
                return ig.doc ? "try a different text" : "Load";
            },
            ok: function () {
...
ig.module("game.entities.enemy")
    .requires("impact.entity", "impact.font", "game.avenir-next", "game.entities.explosion")
    .defines(function () {
...
ig.module("game.entities.player")
    .requires("impact.entity", "impact.entity-pool", "game.entities.emp", "game.entities.particle")
    .defines(function () {
...
ig.module("game.keyboard")
    ...
    .defines(function () {
        ig.Keyboard = ig.Class.extend({
            ...
            hoverImages: { leftEdge: new ig.Image("media/ui/key-edge-left.png"), rightEdge: new ig.Image("media/ui/key-edge-right.png"), normal: new ig.Image("media/ui/key.png") },
            multiBar: new ig.Image("media/ui/bar-blue.png"),
            multiIndicator: new ig.Image("media/ui/multi-indicator.png"),
            multiSounds: { 2: new ig.Sound("media/sounds/multi-2.ogg"), 3: new ig.Sound("media/sounds/multi-3.ogg") },
            width: 0,
            height: 0,
            hoverKey: null,
            expectedKeys: null,
...
ig.module("game.main")
    ...
    .defines(function () {
        ...
        ZType.FLAG = { CASE_SENSITIVE: 1 << 0, PUNCTUATION: 1 << 1, NUMBERS: 1 << 2 };
        ZType.WAVES = {
            MOBILE: {
                fragment: 0,
                wave: 0,
